...
edp_campagnes_en_cours_cat AS (SELECT t4.id_campagne, t4.id_centre, t4.id_secteur, t4.id_edp_releve, t4."Date théorique relève", t4."Campagne", t4."Statut Campagne", t4."Centre", t4."Communicant", t4."Technologie Compteur", t4."Libellé prestataire", t4."Date fin réelle échéance", t4."Date théorique proch. relève", t4."Statut EDP Relève", t4."ACR", t4."Date fin prévue échéance", t4.message_id, t4.rang_pacm_desc, t4."Ecart DTR-auj. en jours cal.", t4."Ecart DTR-auj. en jours ouvrés", t4.ecart_aujourd_hui_proch_DTR_jo, t4.type_date, t4.rang_dtr_depasse, t4.rang_dtr_a_venir, t4.rang_dtr_depasse_unqmt, t4.rang_dtr_a_venir_unqmt, t4.num_categorie, CASE WHEN (num_categorie < -1) THEN 'sup. 9 jours ouv.'
        ...
        ELSE "Date théorique relève" END
         AS date_cat_ecart_auj_DTR_jo
            FROM (SELECT t3.id_campagne, t3.id_centre, t3.id_secteur, t3.id_edp_releve, t3."Date théorique relève", t3."Campagne", t3."Statut Campagne", t3."Centre", t3."Communicant", t3."Technologie Compteur", t3."Libellé prestataire", t3."Date fin réelle échéance", t3."Date théorique proch. relève", t3."Statut EDP Relève", t3."ACR", t3."Date fin prévue échéance", t3.message_id, t3.rang_pacm_desc, t3."Ecart DTR-auj. en jours cal.", t3."Ecart DTR-auj. en jours ouvrés", t3.ecart_aujourd_hui_proch_DTR_jo, t3.type_date, t3.rang_dtr_depasse, t3.rang_dtr_a_venir, t3.rang_dtr_depasse_unqmt, t3.rang_dtr_a_venir_unqmt, coalesce(rang_dtr_a_venir_unqmt, - rang_dtr_depasse_unqmt) AS num_categorie
            FROM (SELECT t2.id_campagne, t2.id_centre, t2.id_secteur, t2.id_edp_releve, t2."Date théorique relève", t2."Campagne", t2."Statut Campagne", t2."Centre", t2."Communicant", t2."Technologie Compteur", t2."Libellé prestataire", t2."Date fin réelle échéance", t2."Date théorique proch. relève", t2."Statut EDP Relève", t2."ACR", t2."Date fin prévue échéance", t2.message_id, t2.rang_pacm_desc, t2."Ecart DTR-auj. en jours cal.", t2."Ecart DTR-auj. en jours ouvrés", t2.ecart_aujourd_hui_proch_DTR_jo, t2.type_date, t2.rang_dtr_depasse, t2.rang_dtr_a_venir, CASE WHEN (type_date = 'depasse') THEN rang_dtr_depasse ELSE null END AS rang_dtr_depasse_unqmt, CASE WHEN (type_date = 'non depasse') THEN rang_dtr_a_venir ELSE null END AS rang_dtr_a_venir_unqmt
            FROM (SELECT t1.id_campagne, t1.id_centre, t1.id_secteur, t1.id_edp_releve, t1."Date théorique relève", t1."Campagne", t1."Statut Campagne", t1."Centre", t1."Communicant", t1."Technologie Compteur", t1."Libellé prestataire", t1."Date fin réelle échéance", t1."Date théorique proch. relève", t1."Statut EDP Relève", t1."ACR", t1."Date fin prévue échéance", t1.message_id, t1.rang_pacm_desc, t1."Ecart DTR-auj. en jours cal.", t1."Ecart DTR-auj. en jours ouvrés", t1.ecart_aujourd_hui_proch_DTR_jo, t1.type_date, DENSE_RANK() OVER (PARTITION BY type_date ORDER BY "Date théorique relève" DESC) AS rang_dtr_depasse, DENSE_RANK() OVER (PARTITION BY type_date ORDER BY "Date théorique relève") AS rang_dtr_a_venir
                FROM (SELECT t0.id_campagne, t0.id_centre, t0.id_secteur, t0.id_edp_releve, t0."Date théorique relève", t0."Campagne", t0."Statut Campagne", t0."Centre", t0."Communicant", t0."Technologie Compteur", t0."Libellé prestataire", t0."Date fin réelle échéance", t0."Date théorique proch. relève", t0."Statut EDP Relève", t0."ACR", t0."Date fin prévue échéance", t0.message_id, t0.rang_pacm_desc, t0."Ecart DTR-auj. en jours cal.", t0."Ecart DTR-auj. en jours ouvrés", t0.ecart_aujourd_hui_proch_DTR_jo, CASE WHEN ("Ecart DTR-auj. en jours ouvrés" < -8) THEN 'depasse' ELSE 'non depasse' END AS type_date
                FROM (SELECT id_campagne, id_centre, id_secteur, id_edp_releve, "Date théorique relève", "Campagne", "Statut Campagne", "Centre", "Communicant", "Technologie Compteur", "Libellé prestataire", "Date fin réelle échéance", "Date théorique proch. relève", "Statut EDP Relève", "ACR", "Date fin prévue échéance", message_id, rang_pacm_desc,
	...
	(trunc("Date théorique relève") - trunc(sysdate)) AS "Ecart DTR-auj. en jours cal.", (SELECT nb_jours_ouvres FROM liste_jours_ouvres WHERE jour = "Date théorique relève") AS "Ecart DTR-auj. en jours ouvrés", (SELECT nb_jours_ouvres FROM liste_jours_ouvres WHERE jour = "Date théorique proch. relève") AS ecart_aujourd_hui_proch_DTR_jo
             ...
             campagne.ID AS id_campagne, centre.ID AS id_centre, secteur.ID AS id_secteur, edp_releve.ID AS id_edp_releve, CASE WHEN (lot.MODELEDELOT_ROLE = 'com.hermes.itv.releve.businessobject.ModeleDeLotDeReleveParTSP') THEN
...
END AS "Technologie Compteur", mode_gestion_zone_releve.LIBELLE AS "Libellé prestataire", echeance.DATEFINREELLE AS "Date fin réelle échéance", pds.DATEPROCHAINERELEVEREELLE AS "Date théorique proch. relève", DECODE(edp_releve.STATUT,
		...
		999, 'mis en lot d’isolés') AS "Statut EDP Relève", acr.LIBELLE AS "ACR", echeance.DATEFINPREVUE AS "Date fin prévue échéance", edp_releve.MESSAGE_ID AS message_id, DENSE_RANK() OVER (PARTITION BY pds.ID ORDER BY pacm.DATEFIN DESC, pacm.DATEDEBUT DESC, pacm.STATUTVALIDE DESC) AS rang_pacm_desc
...
taches_perimetre AS (
	...
	0, 'à faire',
	1, 'en cours',
	2, 'clotûrée') AS "Statut tâche", tache.DATECREATION AS "Date création tâche", tache.DATEECHEANCE AS "Date échéance tâche", tache.DATEFIN AS "Date fin tâche", tache.ELEMENTDETRAVAIL_ROLE AS elementdetravail_role, tache.POSTEDETRAVAIL_ID AS postedetravail_id
...
SELECT * FROM (
            SELECT * FROM (
            SELECT "Date théorique relève", "Campagne", "Statut Campagne", "Communicant", "Technologie Compteur", "Libellé prestataire", "Libellé GT", "Libellé liste de gestion", "Libellé tâche", "Famille de tâche", "Libellé type GT", "Libellé GT père", "Type d'agence", categorie_ecart_auj_DTR_jo, date_cat_ecart_auj_DTR_jo, "Tâche affectée",
            SUM(nb_tac_a_trait_av_proc_prog) AS nb_tac_a_trait_av_proc_prog, SUM(nb_cloturees_auj) AS nb_cloturees_auj, SUM(rang_acr) AS rang_acr, SUM(nb_campagne) AS nb_campagne, SUM(rang_centre) AS rang_centre, SUM(nb_campagne_ouverte) AS nb_campagne_ouverte, SUM(nb_campagnes_clot_auj) AS nb_campagnes_clot_auj, SUM(nb_edp) AS nb_edp, SUM(nb_edp_traites) AS nb_edp_traites, SUM(nb_edp_trait_av_5_jo) AS nb_edp_trait_av_5_jo, SUM(nb_edp_trait_cr_recu) AS nb_edp_trait_cr_recu, SUM(nb_tac_a_trait_av_fin_camp) AS nb_tac_a_trait_av_fin_camp, SUM(nb_tac_a_trait_2_sem_proc_prog) AS nb_tac_a_trait_2_sem_proc_prog
            FROM (
                SELECT "Date théorique relève", "Campagne", "Statut Campagne", "Communicant", "Technologie Compteur", "Libellé prestataire", "Libellé GT", "Libellé liste de gestion", "Libellé tâche", "Famille de tâche", "Libellé type GT", "Libellé GT père", "Type d'agence", categorie_ecart_auj_DTR_jo, date_cat_ecart_auj_DTR_jo, "Tâche affectée", 
                id_campagne, id_centre, id_secteur, id_edp_releve, id_anomalie, id_tache, "Référence tâche", elementdetravail_id, objetmaitre_id,
                
CASE WHEN (premiere_tache = 1 AND tache_a_traiter = 1) THEN 1 ELSE 0 END AS nb_tac_a_trait_av_proc_prog,
CASE WHEN (premiere_tache = 1 AND tache_a_traiter = 0 AND tache_cloturee_aujourd_hui = 1) THEN 1 ELSE 0 END AS nb_cloturees_auj,
CASE WHEN (premier_acr = 1) THEN 1 ELSE 0 END AS rang_acr,
CASE WHEN (premiere_campagne = 1) THEN 1 ELSE 0 END AS nb_campagne,
CASE WHEN (premier_centre = 1) THEN 1 ELSE 0 END AS rang_centre,
CASE WHEN (premiere_campagne = 1 AND "Campagne est ouverte" = 1) THEN 1 ELSE 0 END AS nb_campagne_ouverte,
CASE WHEN (premiere_campagne = 1 AND "Campagne clôturée auj." = 1) THEN 1 ELSE 0 END AS nb_campagnes_clot_auj,
CASE WHEN (premier_edp = 1) THEN 1 ELSE 0 END AS nb_edp,
CASE WHEN (premier_edp = 1 AND edp_est_au_statut_traite = 1) THEN 1 ELSE 0 END AS nb_edp_traites,
CASE WHEN (premier_edp = 1 AND edp_est_au_statut_traite = 1
	AND "Ancienn. camp. inf. eg. 5 jo" = 1) THEN 1 ELSE 0 END AS nb_edp_trait_av_5_jo,
CASE WHEN (premier_edp = 1 AND edp_est_au_statut_traite = 1
	AND "CR relève reçu" = 1) THEN 1 ELSE 0 END AS nb_edp_trait_cr_recu,
CASE WHEN (premiere_tache = 1 AND tache_a_traiter = 1 AND "Fin théo. camp. non dépassée" = 1
	AND "Tac. a trait. av. fin camp." = 1) THEN 1 ELSE 0 END AS nb_tac_a_trait_av_fin_camp,
CASE WHEN (premiere_tache = 1 AND tache_a_traiter = 1 AND "Fin théo. camp. non dépassée" = 0
AND moins_2_sem_av_proc_prog = 1) THEN 1 ELSE 0 END AS nb_tac_a_trait_2_sem_proc_prog
                FROM (
                    (
		SELECT id_campagne, id_centre, id_secteur, id_edp_releve, "Date théorique relève", "Campagne", "Statut Campagne", "Centre", "Communicant", "Technologie Compteur", "Libellé prestataire", "Date fin réelle échéance", "Date théorique proch. relève", "Statut EDP Relève", "ACR", "Date fin prévue échéance", message_id, rang_pacm_desc, "Ecart DTR-auj. en jours cal.", "Ecart DTR-auj. en jours ouvrés", ecart_aujourd_hui_proch_DTR_jo, type_date, rang_dtr_depasse, rang_dtr_a_venir, rang_dtr_depasse_unqmt, rang_dtr_a_venir_unqmt, num_categorie, categorie_ecart_auj_DTR_jo, date_cat_ecart_auj_DTR_jo, date_DTR_jo_agg, id_tache, "Référence tâche", elementdetravail_id, objetmaitre_id, "Libellé GT", "Libellé liste de gestion", "Libellé tâche", "Famille de tâche", "Libellé type GT", "Libellé GT père", "Type d'agence", "Statut tâche", "Date création tâche", "Date échéance tâche", "Date fin tâche", elementdetravail_role, postedetravail_id, id_anomalie, "Anomalie Bloquante", "Date création anomalie", "Date levée ou levée forcée", "NNI agent levée", "Agent levée", "Statut anomalie", "Type d'anomalie",
...
LEFT JOIN taches_perimetre ON anomalie.ID = taches_perimetre.elementdetravail_id
            ...
            GROUP BY "Date théorique relève", "Campagne", "Statut Campagne", "Communicant", "Technologie Compteur", "Libellé prestataire", "Libellé GT", "Libellé liste de gestion", "Libellé tâche", "Famille de tâche", "Libellé type GT", "Libellé GT père", "Type d'agence", categorie_ecart_auj_DTR_jo, date_cat_ecart_auj_DTR_jo, "Tâche affectée"
        )
        )
        ORDER BY "Date théorique relève", "Campagne"
