...
def check_dup():
    ...
    com.print_com("|")
    s = "Vérification des doublons sur la première colonne du fichier"
    s += " de sortie. Chargement du fichier de sortie..."

    com.log(s)
    array_in = com.load_csv(gl.OUT_FILE + gl.OUT_FILE_TYPE)
    com.log("Fichier de sortie chargé. Sauvegarde de la première colonne...")
    com.extract_list(array_in, gl.OUT_DUP_CHECK_LIST_FILE)
    com.log("Première colonne sauvegardée à l'adresse {}".format(
        gl.OUT_DUP_CHECK_LIST_FILE))
