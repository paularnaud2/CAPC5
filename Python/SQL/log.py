...
def process_query_finish(elt, th_nb):
    ...
    if elt == 'MONO':
        ...
        log("Requête exécutée pour la plage {} (pool No.{})".format(
            elt, th_nb))
...
def write_rows_init(range_name, th_nb):
    ...
    if range_name == 'MONO':
        ...
        log("Écriture des lignes en cours pour la plage {}...".format(
            range_name))
    else:
        log("Écriture des lignes en cours pour la plage {} (pool No.{})...".
