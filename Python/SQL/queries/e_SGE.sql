...
(
	...
	AND (  (t_pres.PRE_DEM_DATEEFFET=to_date('01/01/2021','DD/MM/YYYY') and t_rece.PRE_REC_REC_DATE_EFFET in (TO_DATE('31/12/2020', 'DD/MM/YYYY'),TO_DATE('01/01/2021', 'DD/MM/YYYY')))  
         OR(t_pres.PRE_DEM_DATEEFFET=to_date('02/01/2021','DD/MM/YYYY') and t_rece.PRE_REC_REC_DATE_EFFET in (TO_DATE('01/01/2021', 'DD/MM/YYYY'),TO_DATE('02/01/2021', 'DD/MM/YYYY'))) 
         OR(t_pres.PRE_DEM_DATEEFFET=to_date('03/01/2021','DD/MM/YYYY') and t_rece.PRE_REC_REC_DATE_EFFET in (TO_DATE('02/01/2021', 'DD/MM/YYYY'),TO_DATE('03/01/2021', 'DD/MM/YYYY')))
		) 
)
GROUP BY 
 DATE_EFFET_SOUHAITEE
