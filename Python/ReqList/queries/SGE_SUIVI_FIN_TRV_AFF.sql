...
, aff as (
	...
	, dem.DEM_T_REF_DEMANDE REF_DEMANDEUR, dem.DEM_T_REGROUPEMENT REF_REGROUPEMENT, dem.DEM_T_INITIATEUR UTI_LOGIN, uti.UTI_R_CIVILITE UTI_CIV, uti.UTI_T_NOM UTI_NOM, uti.UTI_T_PRENOM UTI_PRENOM
...
, aff.DATE_DEMANDE, aff.DATE_EFFET
...
AND aff.RANG = 1
AND t.PRM IN @@IN1@@
-- AND t.PRM IN ('01273516633705', '01268162040512', '01270477513693', '01273371826499', '01404196735262', '02157018695650')
