...
, CASE WHEN aff.STATUT = 'AFF-ENCOURS' AND aff.PRESTATION IN ('F130A', 'F130B') THEN cal_init.NB_CT ELSE NULL END NB_CT_INIT
, CASE WHEN aff.STATUT = 'AFF-ENCOURS' AND aff.PRESTATION IN ('F130A', 'F130B') THEN cal_cible.NB_CT ELSE NULL END NB_CT_CIBLE
