...
, aff as (
	...
	, dem.DEM_D_DEMANDE DATE_DEMANDE, t_rece.PRE_REC_REC_DATE_EFFET as DATE_EFFET_PREVUE, t_pres.PRE_DEM_DATEEFFET DATE_EFFET_SOUHAITEE
	, DECODE(dem.DEM_B_IS_GINKO, 'O', 'GINKO', 'N', 'DISCO') SI
