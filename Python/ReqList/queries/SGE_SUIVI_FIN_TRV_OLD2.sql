...
, aff_BP as (
	SELECT dem.DEM_ID_PRM as POINT, dem.AFF_T_DISCO as AFFAIRE
...
SELECT PRM, SEG, CODE_INSEE, CODE_DEPARTEMENT, CCD, COMMUNE
...
(
	...
	WHERE 1=1
	-- AND eqeCPT.EQE_ID = (SELECT max(EQE_ID) FROM SGEL_PRM_SCH.T_EQUIPEMENT WHERE SCM_C_ID = prm.SCM_ID)	-- AND prm.PRM_ID IN @@IN1@@
	AND prm.PRM_ID IN ('24262662797365', '09620984080770', '22177279218565', '25675976808201', '02444862487788', '30000731502759', '19524167854286', '01100144557179', '01100289273089', '30000110326267', '30000751220199', '30002130773580', '01181186604919')
	ORDER BY prm.PRM_ID
