WITH ccd_dr as (
	...
	SELECT '232' as "CCD", 'Nord midi Pyrenées' as "DR", 'SO' as "REG" FROM DUAL UNION ALL
	SELECT '233' as "CCD", 'Midi Pyrenées Sud' as "DR", 'SO' as "REG" FROM DUAL UNION ALL
	SELECT '234' as "CCD", 'Nord midi Pyrenées' as "DR", 'SO' as "REG" FROM DUAL UNION ALL
	SELECT '235' as "CCD", 'Nord midi Pyrenées' as "DR", 'SO' as "REG" FROM DUAL UNION ALL
...
SELECT POINT
, CODE_INSEE, CODE_DEPARTEMENT, CODE_CENTRE, ccd_dr.DR, ccd_dr.REG
, SI, EN_SERVICE, OH
...
(
	...
	, prm.PRM_DG_CENTRE_CODE CODE_CENTRE
...
LEFT JOIN ccd_dr ON t.CODE_CENTRE = ccd_dr.CCD