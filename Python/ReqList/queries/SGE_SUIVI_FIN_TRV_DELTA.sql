...
, aff as (
	SELECT dem.DEM_ID_PRM as POINT, dem.AFF_T_DISCO as AFFAIRE, nat.NAT_C_PRESTATION PRS, dem.DEM_R_STATUT STATUT, frn.FRN_T_ACTEUR as FOURNISSEUR
	...
	WHERE 1=1
	AND (
		(dem.DEM_R_STATUT = 'AFF-ENCOURS' AND nat.NAT_C_PRESTATION = 'F130B')
		OR
		(dem.DEM_R_STATUT = 'AFF-TERMINEE' AND nat.NAT_C_PRESTATION IN ('F120B', 'F130B', 'F140') AND dem.DEM_D_DEMANDE >= SYSDATE - 7)
		)
)
...
, aff.AFFAIRE, aff.PRS, aff.STATUT, aff.FOURNISSEUR ,aff.DATE_DEMANDE, aff.DATE_EFFET
