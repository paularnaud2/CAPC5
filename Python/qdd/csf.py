		...
		with open(in_file_dir_1, 'r', encoding='utf-8') as in_file_1:
			with open(in_file_dir_2, 'r', encoding='utf-8') as in_file_2:
				...
				while compare_elt(line_1_list, line_2_list) != " ":
					(line_1_list, line_2_list) = compare_equal(line_1_list, line_2_list, in_file_1, in_file_2, out_file)
					(line_1_list, line_2_list) = compare_inf(line_1_list, line_2_list, in_file_1, out_file)
					(line_1_list, line_2_list) = compare_sup(line_1_list, line_2_list, in_file_2, out_file)
...
def compare_equal(line_1_list, line_2_list, in_file_1, in_file_2, out_file):
	...
	while compare_elt(line_1_list, line_2_list) == "=":
		...
		gl.counters["c2"] += 1
		step_log(gl.counters["c1"], gl.SL_STEP, gl.txt["msg"], gl.counters["out"])
