...
SUB_TAG = ''
MULTI_TAG_LIST = [
    'libelle', 'civilite', 'nom', 'prenom', 'telephone1Num', 'telephone2Num',
    'adresseEmail'
]
N_ROW = 0
...
def gen_img_dict():
    ...
    com.log(
        'Génération du dictionnaire image à partir du fichier {}...'.format(
            IN_FILE))
...
def save_img_dict(dict, out_file_dir, att='w'):
    ...
    com.log("Fichier csv généré à l'adresse {}".format(OUT_FILE))
    print('')
